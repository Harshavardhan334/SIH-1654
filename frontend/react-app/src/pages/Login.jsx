...
export default function Login() {
  const [formData, setFormData] = useState({
    email: '',
    password: '',
    role: 'candidate', // Default role value
  });
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <select
                      name="role"
                      id="role"
                      className="block w-full mt-2.5 py-4 pl-3 pr-10 text-black bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600"
                      value={formData.role}
                      onChange={handleChange}
                    >
